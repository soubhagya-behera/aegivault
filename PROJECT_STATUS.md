...
* Repository total: 594 tests, 0 failures, 0 errors, 0 skipped — 487 pure unit
  tests plus 107 context/persistence/API/lifecycle/execution tests run against the real local
  PostgreSQL.
