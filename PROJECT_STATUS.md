...
* Repository total: 542 tests, 0 failures, 0 errors, 0 skipped — 474 pure unit
  tests plus 68 context/persistence/API/lifecycle/execution tests run against the real local
  PostgreSQL.
